...
namespace CodeMonkey.Utils {
    ...
    public class UI_BarMultiple {
        ...
        private void SetupOutline(Outline outline, Vector2 size) {
            CmUtilsClass.DrawSprite(outline.color, gameObject.transform, Vector2.zero, size + new Vector2(outline.size, outline.size), "Outline");
        }

        private RectTransform SetupBar(Color barColor) {
            RectTransform bar = CmUtilsClass.DrawSprite(barColor, gameObject.transform, Vector2.zero, Vector2.zero, "Bar");
