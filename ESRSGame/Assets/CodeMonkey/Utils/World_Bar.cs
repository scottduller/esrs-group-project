...
namespace CodeMonkey.Utils {
    ...
    public class World_Bar {
        ...
        private void SetupOutline(Outline outline, Vector3 localScale, int sortingOrder) {
            CmUtilsClass.CreateWorldSprite(transform, "Outline", Assets.i.s_White, new Vector3(0,0), localScale + new Vector3(outline.size, outline.size), sortingOrder, outline.color);
        }

        private void SetupBackground(Color backgroundColor, Vector3 localScale, int sortingOrder) {
            background = CmUtilsClass.CreateWorldSprite(transform, "Background", Assets.i.s_White, new Vector3(0,0), localScale, sortingOrder, backgroundColor).transform;
        }
        ...
        private void SetupBar(Color barColor, Vector3 localScale, int sortingOrder) {
            ...
            Transform barIn = CmUtilsClass.CreateWorldSprite(bar, "BarIn", Assets.i.s_White, new Vector3(localScale.x / 2f, 0), localScale, sortingOrder, barColor).transform;
        }
